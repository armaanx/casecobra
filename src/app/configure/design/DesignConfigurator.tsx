...
import { SaveConfigArgsType, saveConfig as _saveConfig } from "./actions";
...
const DesignConfigurator = ({
  ...
  const { mutate: saveConfiguration } = useMutation({
    ...
    mutationFn: async (args: SaveConfigArgsType) => {
      await Promise.all([_saveConfig(args), saveConfig()]);
    },
    onError: () => {
      toast({
  ...
  return (
    <div className="relative mt-20 grid grid-cols-1 lg:grid-cols-3 mb-20 pb-20">
      <div
        ref={containerRef}
        className="relative h-[37.5rem] overflow-hidden col-span-2 w-full max-w-4xl flex items-center justify-center rounded-lg border-2 border-dashed border-zinc-300 p-12 text-center focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
      >
      ...
      <div className="h-[37.5rem] flex flex-col bg-white col-span-full lg:col-span-1">
