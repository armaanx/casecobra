        ...
        <div className="mt-10 border-t border-zinc-200">
          <div className="mt-10 flex flex-auto flex-col">
            ...
            <p className="mt-2 text-sm text-zinc-600">
              We'll replace the case for you if it isn't of the highest quality
            </p>
          </div>
        </div>
        <div className="flex space-x-6 overflow-hidden mt-4 rounded-xl bg-zinc-900/5 ring-1 ring-inset ring-zinc-900/10 lg:rounded-2xl">
          <PhonePreview
            color={color!}
          ...
          <div className="grid grid-cols-2 gap-x-6 border-t border-zinc-200 py-10 text-sm">
            ...
            <div>
              ...
              <p className="mt-2 text-zinc-700">
                BlueDart, takes up to 3-4 working days
              </p>
            </div>
          </div>
        </div>
