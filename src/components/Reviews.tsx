...
function Review({ imgSrc, className, ...props }: ReviewProps) {
  ...
  const animationDelay = DELAYS[Math.floor(Math.random() * DELAYS.length)];
  return (
    <div
      className={cn(
        "animate-fade-in rounded-[2.25rem] bg-white p-6 opacity-0 shadow-xl shadow-zinc-900/5",
        className
      )}
  ...
  return (
    <MaxWidthWrapper className="relative max-w-5xl">
      <img
        ...
        className="hidden absolute select-none xl:block -left-32 top-1/3"
